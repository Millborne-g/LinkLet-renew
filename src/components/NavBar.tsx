    ...
    return (
        <>
            {urlPreviewMode ? (
                ...
                <div
                    className={`w-full bg-white flex items-center justify-center flex-col p-3 gap-3 z-30 transition-shadow duration-200 ${
                        pathname === "/login" ||
                        pathname === "/signup" ||
                        isShareRoute
                            ? "hidden"
                            : ""
                    } ${userDetails ? "sticky top-0 shadow-lg" : "fixed"} ${
                        isScrolled ? "shadow-lg" : ""
                    }`}
                >
                    <div className="flex items-center justify-between w-full lg:max-w-[60rem] lg:px-0 xl:max-w-[76rem] ">
